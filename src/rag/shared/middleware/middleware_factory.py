...
class MiddlewareFactory:
    ...
    def add_auth_middleware(app: FastAPI, config: Dict[str, Any] = None) -> None:
        ...
        """
        from src.rag.shared.middleware.api_key_auth import APIKeyMiddleware
    ...
    def _add_local_rate_limiting(app: FastAPI, config: Dict[str, Any] = None) -> None:
        ...
        Args:
            ...
            config: Rate limiting configuration
        """
        from src.rag.shared.middleware.local_rate_limiter import LocalRateLimiter
    ...
    def add_request_logging_middleware(app: FastAPI, config: Dict[str, Any] = None) -> None:
        ...
        """
        from src.rag.shared.middleware.request_logger import RequestLoggingMiddleware
